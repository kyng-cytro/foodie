    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="flex flex-col p-4 mt-4 border  rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  bg-gray-800 md:bg-gray-900 border-gray-700">
                ...
                <a href="<?php echo SITEURL . '/admin/logout.php'  ?>" class="my-1 items-center justify-end text-white flex md:hidden space-x-1 font-light hover:underline">
        ...
        <a href="<?php echo SITEURL . '/admin/logout.php'  ?>" class="items-center text-white hidden md:flex space-x-1 font-light hover:underline">
